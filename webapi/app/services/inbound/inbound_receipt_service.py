...
from app.schemas.inbound.inbound_receipt import (
...
from app.repositories.inbound.inbound_receipt_repository import InboundReceiptRepository
    ...
    async def complete_inbound(self, id: int, inbound_person: str, current_user: CurrentUser) -> Tuple[bool, str]:
        ...
        for receipt_item in receipt_items:
            query = select(Stock).where(
                ...
                Stock.batch_no == (receipt_item.batch_no or ''),
                Stock.production_date == (receipt_item.production_date or 0),
