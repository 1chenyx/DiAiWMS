...
from app.schemas.system.freightfee import FreightfeeCreate, FreightfeeUpdate, FreightfeeViewModel
from app.core.current_user import CurrentUser
from app.repositories.system.freightfee_repository import FreightFeeRepository
