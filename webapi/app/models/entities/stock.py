...
class Stock(WMSBaseModel):
    ...
    warehouse_location_name = mapped_column(String(100), nullable=False, default="", comment="库位名称")
    spu_name = mapped_column(String(100), nullable=False, default="", comment="商品名称")
    ...
    batch_no = mapped_column(String(64), nullable=False, default="", comment="批次号")
    production_date = mapped_column(BigInteger, nullable=False, default=0, comment="生产日期")
