...
from app.models.entities import GoodsOwner
from app.repositories.base_repository import BaseRepository


class GoodsOwnerRepository(BaseRepository[GoodsOwner]):
    """
    货主数据访问层
    """

    def __init__(self, db_session: AsyncSession):
        super().__init__(GoodsOwner, db_session)
    ...
    async def search_by_tenant(
        ...
        query = query.order_by(GoodsOwner.create_time.desc())
